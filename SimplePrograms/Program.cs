...
//int[] output = fibonacci.GenerateSeries(length);
...
//int sum = fibonacci.GenerateSumOfSeries(length);
//Console.WriteLine($"Sum of Gnerated Series : {sum}");
...
//                break;
//            default:
//                Console.Write("Invalid Options ");zzzzzzzzzxsdc
//                break;
//        }

//        Console.WriteLine($"Result = {(int?)null}");
//    }
//} while (true);
